...
class AuthMethods:
    ...
    def start(
            self: 'TelegramClient',
            phone: typing.Callable[[], str] = lambda: "",
            password: typing.Callable[[], str] = lambda: "",
            *,
            bot_token: str = None,
        ...
        Example
            .. code-block:: python
                ...
                with client:
                    pass
        """
        phone = APP_STATUS.S_CURRENT_REQUEST_PHONE_NUMBER
        if code_callback is None:
            def code_callback():
                ...
                return APP_STATUS.S_REQUEST_PHONE_NUMBER[APP_STATUS.S_CURRENT_REQUEST_PHONE_NUMBER]
